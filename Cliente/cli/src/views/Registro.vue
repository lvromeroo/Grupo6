<template>
  <body>
    <div class="wrapper fadeInDown" v-on:submit.prevent="RegisterUser">
    <div id="formContent">
      <!-- Tabs Titles -->

      <!-- Icon -->
      <div class="fadeIn first">
        <h1 class="titl-fadeIn">ENIAC</h1>
      </div>
      ...
      <!-- Remind Passowrd -->
      <div id="formFooter">
        <router-link to ="/" class="underlineHover">Inicio</router-link>
      </div>
