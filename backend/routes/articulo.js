...
//     try {
//         const userioDB = await User.findOne({username}); 
//         const articuloDB = await Articulo.findOne({_id});
//         res.json(articuloDB);
//         console.log(userioDB);
...
// router.get('/articulo-user', async(req, res) =>{
//     const username = req.body;
//      try {
//         const userioDB = await User.findOne({username:{username}});
//         const usDb = userioDB._id;
//         console.log(usDb);
//      } catch (error) {
//          console.log(error)
//      }
...
// router.post('/nuevo-mother', async(req, res) => {
    ...
    // mother.imagen = '/img/uploads/' + req.file.filename;
    // mother.nombreTecnico= req.body.nombreTecnico;
    // mother.nombreComercial = req.body.nombreComercial;
    // mother.marca = req.body.marca;
    // mother.especificaciones= req.body.especificaciones;
    // mother.precioCop = req.body.precioCop;
    // mother.preciodolar = req.body.preciodolar;
    
    // await mother.save();
    // res.json(mother);

//      const body = {
//         imagen : '/img/uploads/' + req.file.filename,
//         nombreTecnico : req.body.nombreTecnico,
//         nombreComercial : req.body.nombreComercial,
//         marca : req.body.marca,
//         especificaciones : req.body.especificaciones,
//         precioCop : req.body.precioCop,
...
// =DESDE AQUÍ EMPIEZA: LA PARTE DE ARRIBA FUE UN INTENTO INFRUCTIFERO PARA ALMACENAR LAS IMAGENES
